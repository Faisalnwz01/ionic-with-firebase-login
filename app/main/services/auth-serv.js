'use strict';
angular.module('main')
  .service('Auth', function ($log, FURL, $firebaseAuth, $firebaseArray, $firebaseObject, Utils) {

    $log.log('Hello from your Service: Auth in module main');
    ...
    var Auth = {
      ...
      resetpassword: function(user) {
        return auth.$resetPassword({
          ...
          Utils.alertshow("Password Reset", "Password reset email sent successfully!");
